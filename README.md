...
**[Click here to navigate a map that aggregates the data by zip code.](https://juliaingram.github.io/zocdoc-scrape)** Clicking on a zip code will display a list of providers in that zip code, the number of upcoming available appointments and the soonest available appointment, as well as the number of providers who speak Spanish or Chinese. 
